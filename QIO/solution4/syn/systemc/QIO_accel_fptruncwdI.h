...
// ==============================================================
#ifndef __QIO_accel_fptruncwdI__HH__
#define __QIO_accel_fptruncwdI__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(QIO_accel_fptruncwdI) {
    ...
    SC_CTOR(QIO_accel_fptruncwdI):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
