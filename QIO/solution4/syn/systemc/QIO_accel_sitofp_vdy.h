...
// ==============================================================
#ifndef __QIO_accel_sitofp_vdy__HH__
#define __QIO_accel_sitofp_vdy__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(QIO_accel_sitofp_vdy) {
    ...
    SC_CTOR(QIO_accel_sitofp_vdy):  ACMP_sitofp_U ("ACMP_sitofp_U") {
