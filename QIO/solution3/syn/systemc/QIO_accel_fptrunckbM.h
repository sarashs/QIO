...
// ==============================================================
#ifndef __QIO_accel_fptrunckbM__HH__
#define __QIO_accel_fptrunckbM__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(QIO_accel_fptrunckbM) {
    ...
    SC_CTOR(QIO_accel_fptrunckbM):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
