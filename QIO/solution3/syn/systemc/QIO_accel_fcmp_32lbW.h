...
// ==============================================================
#ifndef __QIO_accel_fcmp_32lbW__HH__
#define __QIO_accel_fcmp_32lbW__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(QIO_accel_fcmp_32lbW) {
    ...
    SC_CTOR(QIO_accel_fcmp_32lbW):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
