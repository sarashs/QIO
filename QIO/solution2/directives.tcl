...
set_directive_array_partition -type block -factor 2 -dim 1 "QIO_accel" coef_list
set_directive_array_partition -type block -factor 2 -dim 1 "QIO_accel_hw" current_val
set_directive_unroll -factor 2 "QIO_accel_hw/QIO_loop2"
