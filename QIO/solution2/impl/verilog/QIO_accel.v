...
reg   [0:0] icmp_ln76_reg_383;
reg    ap_enable_reg_pp2_iter2;
reg   [0:0] icmp_ln76_reg_383_pp2_iter1_reg;
reg   [8:0] i_0_i1_reg_205;
wire   [8:0] i_fu_240_p2;
reg    ap_block_state2;
wire   [16:0] add_ln58_fu_257_p2;
reg    ap_block_state4;
wire   [8:0] select_ln64_1_fu_283_p3;
wire   [8:0] j_fu_323_p2;
reg   [31:0] seed_read_reg_378;
wire    ap_CS_fsm_state6;
wire   [0:0] icmp_ln76_fu_329_p2;
...
wire   [0:0] icmp_ln80_fu_341_p2;
reg   [0:0] icmp_ln80_reg_392;
...
wire   [63:0] zext_ln54_fu_246_p1;
wire   [63:0] zext_ln64_1_fu_318_p1;
wire   [63:0] zext_ln83_fu_347_p1;
wire    ap_block_pp2_stage0_01001;
wire   [0:0] icmp_ln60_fu_269_p2;
wire   [8:0] i_4_fu_263_p2;
wire   [16:0] tmp_s_fu_291_p3;
wire   [8:0] select_ln64_fu_275_p3;
wire   [17:0] zext_ln64_fu_308_p1;
wire   [17:0] zext_ln60_fu_299_p1;
wire   [17:0] add_ln64_fu_312_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        i1_0_i_reg_183 <= 9'd0;
    end else if ((~((icmp_ln58_fu_251_p2 == 1'd0) & (input_r_TVALID_int == 1'b0)) & (icmp_ln58_fu_251_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        i1_0_i_reg_183 <= select_ln64_1_fu_283_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln76_fu_329_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp2_stage0) & (ap_enable_reg_pp2_iter0 == 1'b1) & (1'b0 == ap_block_pp2_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((~((icmp_ln52_fu_234_p2 == 1'd0) & (input_r_TVALID_int == 1'b0)) & (icmp_ln52_fu_234_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln76_fu_329_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp2_stage0) & (1'b0 == ap_block_pp2_stage0_11001))) begin
...
always @ (*) begin
    if ((icmp_ln76_fu_329_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        coef_list_address0 = zext_ln64_1_fu_318_p1;
...
always @ (*) begin
    if ((~((icmp_ln58_fu_251_p2 == 1'd0) & (input_r_TVALID_int == 1'b0)) & (1'b1 == ap_CS_fsm_state4))) begin
        coef_list_ce0 = 1'b1;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        coef_list_ce0 = grp_QIO_accel_hw_int_s_fu_216_coef_list_ce0;
    end else begin
...
always @ (*) begin
    if ((~((icmp_ln58_fu_251_p2 == 1'd0) & (input_r_TVALID_int == 1'b0)) & (icmp_ln58_fu_251_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        coef_list_we0 = 1'b1;
    end else begin
        coef_list_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp2_stage0) & (1'b1 == ap_CS_fsm_pp2_stage0) & (ap_enable_reg_pp2_iter0 == 1'b1))) begin
        final_val_address0 = zext_ln83_fu_347_p1;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        final_val_address0 = grp_QIO_accel_hw_int_s_fu_216_final_val_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        init_val_address0 = zext_ln54_fu_246_p1;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        init_val_address0 = grp_QIO_accel_hw_int_s_fu_216_init_val_address0;
    end else begin
...
always @ (*) begin
    if ((~((icmp_ln52_fu_234_p2 == 1'd0) & (input_r_TVALID_int == 1'b0)) & (1'b1 == ap_CS_fsm_state2))) begin
        init_val_ce0 = 1'b1;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        init_val_ce0 = grp_QIO_accel_hw_int_s_fu_216_init_val_ce0;
    end else begin
...
always @ (*) begin
    if ((((icmp_ln58_fu_251_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4)) | ((icmp_ln52_fu_234_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((~((icmp_ln58_fu_251_p2 == 1'd0) & (input_r_TVALID_int == 1'b0)) & (icmp_ln58_fu_251_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4)) | (~((icmp_ln52_fu_234_p2 == 1'd0) & (input_r_TVALID_int == 1'b0)) & (icmp_ln52_fu_234_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp2_stage0) & (icmp_ln76_reg_383_pp2_iter1_reg == 1'd0) & (ap_enable_reg_pp2_iter2 == 1'b1)) | ((1'b0 == ap_block_pp2_stage0) & (icmp_ln76_reg_383 == 1'd0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)))) begin
...
always @ (*) begin
    if (((icmp_ln76_reg_383 == 1'd0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0) & (1'b0 == ap_block_pp2_stage0_11001))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~((icmp_ln52_fu_234_p2 == 1'd0) & (input_r_TVALID_int == 1'b0)) & (icmp_ln52_fu_234_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if ((~((icmp_ln52_fu_234_p2 == 1'd0) & (input_r_TVALID_int == 1'b0)) & (icmp_ln52_fu_234_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        ap_ST_fsm_state4 : begin
            if ((~((icmp_ln58_fu_251_p2 == 1'd0) & (input_r_TVALID_int == 1'b0)) & (icmp_ln58_fu_251_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end else if ((~((icmp_ln58_fu_251_p2 == 1'd0) & (input_r_TVALID_int == 1'b0)) & (icmp_ln58_fu_251_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ...
        ap_ST_fsm_pp2_stage0 : begin
            if ((~((ap_enable_reg_pp2_iter1 == 1'b0) & (1'b0 == ap_block_pp2_stage0_subdone) & (ap_enable_reg_pp2_iter0 == 1'b1) & (icmp_ln76_fu_329_p2 == 1'd1)) & ~((ap_enable_reg_pp2_iter1 == 1'b0) & (1'b0 == ap_block_pp2_stage0_subdone) & (ap_enable_reg_pp2_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp2_stage0;
            end else if ((((ap_enable_reg_pp2_iter1 == 1'b0) & (1'b0 == ap_block_pp2_stage0_subdone) & (ap_enable_reg_pp2_iter0 == 1'b1) & (icmp_ln76_fu_329_p2 == 1'd1)) | ((ap_enable_reg_pp2_iter1 == 1'b0) & (1'b0 == ap_block_pp2_stage0_subdone) & (ap_enable_reg_pp2_iter2 == 1'b1)))) begin
...
assign add_ln58_fu_257_p2 = (indvar_flatten_reg_172 + 17'd1);

assign add_ln64_fu_312_p2 = (zext_ln64_fu_308_p1 + zext_ln60_fu_299_p1);
...
always @ (*) begin
    ap_block_state10_io = ((icmp_ln76_reg_383_pp2_iter1_reg == 1'd0) & (output_r_TREADY_int == 1'b0));
end

assign ap_block_state10_pp2_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2 = ((icmp_ln52_fu_234_p2 == 1'd0) & (input_r_TVALID_int == 1'b0));
end

always @ (*) begin
    ap_block_state4 = ((icmp_ln58_fu_251_p2 == 1'd0) & (input_r_TVALID_int == 1'b0));
end

assign ap_block_state8_pp2_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state9_io = ((icmp_ln76_reg_383 == 1'd0) & (output_r_TREADY_int == 1'b0));
end
...
assign icmp_ln52_fu_234_p2 = ((i_0_i_reg_161 == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln58_fu_251_p2 = ((indvar_flatten_reg_172 == 17'd65536) ? 1'b1 : 1'b0);

assign icmp_ln60_fu_269_p2 = ((j_0_i_reg_194 == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln76_fu_329_p2 = ((i_0_i1_reg_205 == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln80_fu_341_p2 = ((i_0_i1_reg_205 == 9'd255) ? 1'b1 : 1'b0);

assign j_fu_323_p2 = (select_ln64_fu_275_p3 + 9'd1);

assign output_r_TVALID = regslice_both_output_data_V_U_vld_out;

assign select_ln64_1_fu_283_p3 = ((icmp_ln60_fu_269_p2[0:0] === 1'b1) ? i_4_fu_263_p2 : i1_0_i_reg_183);

assign select_ln64_fu_275_p3 = ((icmp_ln60_fu_269_p2[0:0] === 1'b1) ? 9'd0 : j_0_i_reg_194);

assign tmp_s_fu_291_p3 = {{select_ln64_1_fu_283_p3}, {8'd0}};

assign zext_ln54_fu_246_p1 = i_0_i_reg_161;

assign zext_ln60_fu_299_p1 = tmp_s_fu_291_p3;

assign zext_ln64_1_fu_318_p1 = add_ln64_fu_312_p2;

assign zext_ln64_fu_308_p1 = select_ln64_fu_275_p3;

assign zext_ln83_fu_347_p1 = i_0_i1_reg_205;
