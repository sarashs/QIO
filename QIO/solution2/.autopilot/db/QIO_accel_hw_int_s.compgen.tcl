...
set ID 26
set hasByteEnable 0
set MemName QIO_accel_hw_int_bkb
...
set ID 27
set hasByteEnable 0
set MemName QIO_accel_hw_int_dEe
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 256
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename coef_list_0 \
    op interface \
    ports { coef_list_0_address0 { O 15 vector } coef_list_0_ce0 { O 1 bit } coef_list_0_q0 { I 32 vector } coef_list_0_address1 { O 15 vector } coef_list_0_ce1 { O 1 bit } coef_list_0_q1 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'coef_list_0'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename coef_list_1 \
    op interface \
    ports { coef_list_1_address0 { O 15 vector } coef_list_1_ce0 { O 1 bit } coef_list_1_q0 { I 32 vector } coef_list_1_address1 { O 15 vector } coef_list_1_ce1 { O 1 bit } coef_list_1_q1 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'coef_list_1'"
}
}
