...
// ==============================================================
#ifndef __QIO_accel_sitofp_hbi__HH__
#define __QIO_accel_sitofp_hbi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(QIO_accel_sitofp_hbi) {
    ...
    SC_CTOR(QIO_accel_sitofp_hbi):  ACMP_sitofp_U ("ACMP_sitofp_U") {
