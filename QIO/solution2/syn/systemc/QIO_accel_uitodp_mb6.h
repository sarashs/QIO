...
// ==============================================================
#ifndef __QIO_accel_uitodp_mb6__HH__
#define __QIO_accel_uitodp_mb6__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(QIO_accel_uitodp_mb6) {
    ...
    SC_CTOR(QIO_accel_uitodp_mb6):  ACMP_uitodp_U ("ACMP_uitodp_U") {
